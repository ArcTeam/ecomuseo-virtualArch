$(document).ready(function() {
  ...
  $("[name=chooseLang]").on('click', function(){
    ...
    $(".lang").fadeOut('fast', function(){
      $(".TourSelect > p").text(gui.TourSelect[localStorage.lang])
      $(".TourSelect").fadeIn('fast')
    })
  })
  $("[name=TourSelect]").on('click', function(){
    localStorage.setItem("TourSelect","ok")
    $(".TourSelect,.appTitle").fadeOut('fast', function(){
